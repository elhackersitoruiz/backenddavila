...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Carpeta física donde se guardan
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / "staticfiles"  # Ruta absoluta para collectstatic
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "motorrepuestosdavila@gmail.com"
EMAIL_HOST_PASSWORD = "cclg vwbo ocgx nxwk"
